    ...
    layers: [
      {
        ...
        arguments: {
          tf: { value: "required", type: "str", render: "text", options: "tf" },
          keras: {
            value: "required",
            type: "str",
            render: "text",
      ...
      },
      {
        ...
        arguments: {
          ...
          kernel_constraint: {
            ...
            type: "str",
            render: "list",
            options: "kernel_constraint",
          },
          bias_constraint: {
            value: "None",
            type: "str",
            render: "list",
            options: "bias_constraint",
          },
        },
      },
      {
      ...
      },
      {
        ...
        arguments: {
          ...
          embeddings_initializer: {
            ...
            type: "str",
            render: "list",
            options: "embeddings_initializer",
          },
          embeddings_regularizer: {
            value: "None",
            type: "str",
            render: "list",
            options: "embeddings_regularizer",
          },
          activity_regularizer: {
            value: "None",
            type: "str",
      ...
      },
      {
        ...
        arguments: {
          ...
          depthwise_regularizer: {
            ...
            type: "str",
            render: "list",
            options: "depthwise_regularizer",
          },
          pointwise_regularizer: {
            value: "None",
            type: "str",
            render: "list",
            options: "pointwise_regularizer",
          },
          bias_regularizer: {
            value: "None",
            type: "str",
          ...
          depthwise_constraint: {
            ...
            type: "str",
            render: "list",
            options: "depthwise_constraint",
          },
          pointwise_constraint: {
            value: "None",
            type: "str",
            render: "list",
            options: "pointwise_constraint",
          },
          bias_constraint: {
            value: "None",
            type: "str",
    ...
    layers: [
      {
        ...
        arguments: {
          ...
          output_sequence_length: {
            ...
            type: "str",
            render: "text",
            options: "output_sequence_length",
          },
          pad_to_max_tokens: {
            value: "True",
            type: "bool",
    ...
    layers: [
      {
        ...
        arguments: {
          ...
          beta_initializer: {
            ...
            type: "str",
            render: "list",
            options: "beta_initializer",
          },
          gamma_initializer: {
            value: "ones",
            type: "str",
            render: "list",
            options: "gamma_initializer",
          },
          moving_mean_initializer: {
            value: "zeros",
            type: "str",
            render: "list",
            options: "moving_mean_initializer",
          },
          moving_variance_initializer: {
            value: "ones",
            type: "str",
            render: "list",
            options: "moving_variance_initializer",
          },
          beta_regularizer: {
            value: "None",
            type: "str",
            render: "list",
            options: "beta_regularizer",
          },
          gamma_regularizer: {
            value: "None",
            type: "str",
            render: "list",
            options: "gamma_regularizer",
          },
          beta_constraint: {
            value: "None",
            type: "str",
            render: "list",
            options: "beta_constraint",
          },
          gamma_constraint: {
            value: "None",
            type: "str",
          ...
          renorm_clipping: {
            ...
            type: "str",
            render: "text",
            options: "renorm_clipping",
          },
          renorm_momentum: {
            value: "0",
            type: "int",
            render: "text",
            options: "renorm_momentum",
          },
          fused: {
            value: "None",
            type: "str",
      ...
      },
      {
        ...
        arguments: {
          alpha_initializer: {
            ...
            type: "str",
            render: "list",
            options: "alpha_initializer",
          },
          alpha_regularizer: {
            value: "None",
            type: "str",
            render: "list",
            options: "alpha_regularizer",
          },
          alpha_constraint: {
            value: "None",
            type: "str",
            render: "list",
            options: "alpha_constraint",
          },
          shared_axes: {
            value: "None",
            type: "str",
