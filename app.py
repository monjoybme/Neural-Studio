...
from studio.graph import DatasetDef, GraphDef
...
from studio.utils import download_options, generate_args, get_hardware_utilization
from studio.web import App, Lith, Request, json_response, text_response, send_file, types
...
async def _static_view(request: Request, file: str) -> types.static:
    _, *file = file.split("/")
    file = "/".join(file)
